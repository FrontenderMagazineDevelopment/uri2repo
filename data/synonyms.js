module.exports = {
  ...
  'half-precision-float': 'precision',
  ...
  'mongo-java': 'mongodb-java',
  unmarshall: 'unmarshalling',
  dba: 'database-administration',
  'gem-bundler': 'bundler',
  bundle: 'bundler',
  nsfetchedresultcontroller: 'nsfetchedresultscontroller',
  gui: 'user-interface',
  'b+-tree': 'b-tree',
  domain: 'dns',
  keys: 'key',
  ...
  singlepage: 'single-page-application',
  identifiers: 'identifier',
  'zc.buildout': 'buildout',
  requests: 'python-requests',
  h5bp: 'html5boilerplate',
  ...
  uitable: 'uitableview',
  'xamarin.mac': 'monomac',
  formbuilder: 'oracleforms',
  actionfilterattribute: 'action-filter',
  viewcontroller: 'uiviewcontroller',
  'permanent-generation': 'permgen',
  'facebook-wall': 'facebook-timeline',
  'vs-macros': 'visual-studio-macros',
  etree: 'elementtree',
  ...
  itextpdf: 'itext',
  ical: 'icalendar',
  'in-the-wild': 'production',
  impersonate: 'impersonation',
  crawl: 'web-crawler',
  crawling: 'web-crawler',
  'php-frameworks': 'php',
  japplet: 'applet',
  'google-experiments': 'google-website-optimizer',
  workspaces: 'workspace',
  'tfs-service': 'azure-devops',
  jpg: 'jpeg',
  ...
  storing: 'storage',
  hiveql: 'hive',
  xhtmlrenderer: 'flying-saucer',
  'spring-data-mongodb': 'spring-data-document',
  actionbarsherlock: 'android-actionbar',
  ...
  'xml-transform': 'xslt',
  velocity: 'appfabric-cache',
  nettiers: '.nettiers',
  uistoryboard: 'storyboard',
  'xcode-storyboard': 'storyboard',
  arrayindexoutofbounds: 'indexoutofboundsexception',
  ...
  'exec-bad-access': 'exc-bad-access',
  'css-clear': 'css-float',
  ...
  'ipad-standalone-mode': 'iphone-standalone-web-app',
  'html-tag': 'html',
  td: 'html-table',
  rowspan: 'html-table',
  colspan: 'html-table',
  'system.web.optimization': 'asp.net-optimization',
  workbook: 'excel',
  emmett: 'emmet',
  zencoding: 'emmet',
  'zen-coding': 'emmet',
  ...
  'zend-engine': 'php-internals',
  'php-references': 'reference',
  references: 'reference',
  'php.ini': 'php',
  'php-modules': 'php-extension',
  'iphone-ios': 'iphone',
  ...
  pgrep: 'grep',
  'idle-ide': 'python-idle',
  'known-type': 'known-types',
  'linq-expressions': 'expression-trees',
  'auto-properties': 'automatic-properties',
  apns: 'apple-push-notifications',
  roasal: 'roassal',
  phusion: 'passenger',
  'iphone-provisioning': 'ios-provisioning',
  ...
  cs5: 'flash-cs5',
  'adobe-flash-cs5': 'flash-cs5',
  pendingintent: 'android-pendingintent',
  ...
  'tfs-api': 'tfs-sdk',
  'matlab-standalone': 'matlab-compiler',
  'ie8-developer-tools': 'ie-developer-tools',
  'ie9-developer-tools': 'ie-developer-tools',
  'reporting-services-2012': 'ssrs-2012',
  airplay: 'marmalade',
  vc: 'visual-c++',
  aria: 'wai-aria',
  sounds: 'audio',
  ...
  audiomanager: 'android-audiomanager',
  tchart: 'teechart',
  'struts2-jquery-plugin': 'struts2-jquery',
  ...
  'absolute-positioning': 'css-position',
  ...
  gwtp: 'gwt-platform',
  ics: 'icalendar',
  cupcake: 'android-1.5-cupcake',
  'android-donut': 'android-1.6-donut',
  'ice-cream-sandwich': 'android-4.0-ice-cream-sandwich',
  'jelly-bean': 'android-4.2-jelly-bean',
  froyo: 'android-2.2-froyo',
  'android-froyo': 'android-2.2-froyo',
  'android-cupcake': 'android-1.5-cupcake',
  'android-jelly-bean': 'android-4.2-jelly-bean',
  'android-ics': 'android-4.0-ice-cream-sandwich',
  gingerbread: 'android-2.3-gingerbread',
  'android-gingerbread': 'android-2.3-gingerbread',
  honeycomb: 'android-3.0-honeycomb',
  'android-eclair': 'android-2.0-eclair',
  ...
  'data-attributes': 'custom-data-attribute',
  ...
  'customer-account-data': 'customer-account-data-api',
  'program-flow': 'control-flow',
  sailsjs: 'sails.js',
  mvcscaffolding: 'asp.net-mvc-scaffolding',
  playbook: 'blackberry-playbook',
  interrupts: 'interrupt',
  'blackberry-world': 'appworld',
  caliburn: 'caliburn.micro',
  'pseudo-terminals': 'pty',
  iam: 'amazon-iam',
  'embedded-v8': 'v8',
  'data-uri-scheme': 'data-uri',
  ...
  'stateless-session-beans': 'stateless-session-bean',
  'android-images': 'android-image',
  patterns: 'design-patterns',
  'string-similarity': 'similarity',
  'similarity-analyzer': 'similarity',
  'spring-tool-suite': 'sts-springsourcetoolsuite',
  perlre: 'regex',
  xmlns: 'xml-namespaces',
  painting: 'paint',
  'ie7-bug': 'internet-explorer-7',
  'ie6-bug': 'internet-explorer-6',
  'safari-bug': 'safari',
  samples: 'sample',
  ...
  'embedded-matlab': 'matlab-coder',
  'matlab-ide': 'matlab',
  'matlab-path': 'matlab',
  'parameterized-queries': 'parameterized-query',
  'php-errors': 'php',
  jdk8: 'java-8',
  filelock: 'file-locking',
  sentestingkit: 'ocunit',
  complexity: 'complexity-theory',
  'magento-widgets': 'magento',
  'magento-module': 'magento',
  omniture: 'adobe-analytics',
  'site-catalyst': 'adobe-analytics',
  mvc4: 'asp.net-mvc-4',
  cef: 'chromium-embedded',
  parenthesis: 'parentheses',
  uimapview: 'mkmapview',
  'mysql-table': 'mysql',
  'rules-engines': 'rule-engine',
  ...
  'web-optimization': 'asp.net-optimization',
  conformance: 'standards-compliance',
  xhtml5: 'html5',
  gpg: 'gnupg',
  'xquery-update': 'xquery',
  nil: 'null',
  splitting: 'split',
  'android-stylesheets': 'android-styles',
  pnacl: 'google-nativeclient',
  ...
  'bit-shift-operators': 'bit-shift',
  'min-height': 'css',
  'min-width': 'css',
  'max-height': 'css',
  'max-width': 'css',
  msvc11: 'visual-studio-2012',
  mavericks: 'osx-mavericks',
  animated: 'animation',
  rotateanimation: 'animation',
  scaleanimation: 'animation',
  syncframework: 'microsoft-sync-framework',
  ...
  'joomla3.2': 'joomla3.0',
  'joomla3.x': 'joomla3.0',
  'nhibernate-queryover': 'queryover',
  ...
  'jquery-sortable': 'jquery-ui-sortable',
  ...
  owa: 'outlook-web-app',
  boss: 'yahoo-boss',
  'team-foundation-service': 'azure-devops',
  tooltips: 'tooltip',
  'mac-os-x-server': 'osx-server',
  'osx-10.9': 'osx-mavericks',
  ...
  iis7: 'iis-7',
  iis8: 'iis-8',
  'android-sdk-2.2': 'android-2.2-froyo',
  'pickle-dump': 'pickle',
  'filter-branch': 'git-filter-branch',
  inherit: 'inheritance',
  sklearn: 'scikit-learn',
  ranges: 'range',
  'worklight-deployment': 'worklight-server',
  'groupwise-maximum': 'greatest-n-per-group',
  'android-test-kit': 'android-espresso',
  'soa-suite': 'soa',
  'laravel-4.1': 'laravel-4',
  'valid-xhtml': 'xhtml',
  ...
  uisegmentcontrol: 'uisegmentedcontrol',
  workitem: 'tfs-workitem',
  python3: 'python-3.x',
  'division-by-zero': 'divide-by-zero',
  'self-referential': 'self-reference',
  'self-referencing': 'self-reference',
  g1: 'g1gc',
  'duplicate-entry': 'duplicates',
  'shorthand-if': 'conditional-operator',
  ...
  'symbolic-computation': 'symbolic-math',
  ...
  cv: 'computer-vision',
  vstemplate: 'visual-studio-templates',
  avg: 'average',
  appendto: 'append',
  appcompat: 'android-actionbar-compat',
  'conditional-expressions': 'conditional-operator',
  dynamics: 'microsoft-dynamics',
  actionbarcompat: 'android-actionbar-compat',
  ...
  'css-backface-visibility': 'css-transforms',
  'web-browser': 'browser',
  mpich2: 'mpich',
  robots: 'robot',
  pig: 'apache-pig',
  ...
  'android-1.6': 'android-1.6-donut',
  queryselectorall: 'selectors-api',
  'string-utils': 'apache-stringutils',
  'neo4j2.0': 'neo4j',
  socketio: 'socket.io',
  wampserver: 'wamp',
  modulus: 'modulo',
  ...
  vsnprintf: 'printf',
  vswprintf: 'printf',
  'nokia-location-api': 'here-api',
  'microsoft-appstore': 'windows-store',
  tomee: 'apache-tomee',
  simulate: 'simulation',
  edittext: 'android-edittext',
  appwidget: 'android-appwidget',
  div: 'html',
  divs: 'html',
  'nested-divs': 'html',
  'div-layouts': 'html',
  ...
  'asp.net.mvc': 'asp.net-mvc',
  'kendo-ui-mvc': 'kendo-asp.net-mvc',
  'cabal-install': 'cabal',
  zf2: 'zend-framework2',
  dbms: 'database',
  sesame: 'openrdf',
  ...
  'xcode-playground': 'swift-playground',
  'ring-buffer': 'circular-buffer',
  'pebble-sdk': 'pebble-watch',
  'x-window': 'x11',
  ...
  nsdocumentsdirectory: 'nsdocumentdirectory',
  stellarjs: 'stellar.js',
  'angular.js': 'angularjs',
  'aspnet.mvc': 'asp.net-mvc',
  'aspnet-mvc': 'asp.net-mvc',
  numberformat: 'number-formatting',
  'signal-slot': 'signals-slots',
  ...
  gameloop: 'game-loop',
  nancyfx: 'nancy',
  'cocos2d-swift': 'cocos2d-iphone',
  'ruby-c-api': 'ruby-c-extension',
  'ruby-extension': 'ruby-c-extension',
  'ruby-ext': 'ruby-c-extension',
  'if-clause': 'if-statement',
  'software-as-a-service': 'saas',
  c90: 'c89',
  'progress-database': 'progress-db',
  csharp: 'c#',
  route: 'routes',
  karaf: 'apache-karaf',
  ...
  engopen: 'matlab-engine',
  'compass-css': 'compass-sass',
  autobahnws: 'autobahn',
  ...
  alternation: 'regex-alternation',
  sibling: 'siblings',
  urlrewriter: 'url-rewriting',
  rewritemap: 'mod-rewrite',
  handhelddevice: 'mobile-devices',
  handheld: 'mobile-devices',
  'symfony-sonata': 'sonata-admin',
  'bing-maps-api': 'bing-maps',
  'bing-maps-controls': 'bing-maps',
  ...
  lookaround: 'regex-lookarounds',
  'matlab-toolbox': 'matlab',
  containment: 'contains',
  'negative-lookahead': 'regex-lookarounds',
  lookahead: 'regex-lookarounds',
  ...
  'paypal-sdk': 'paypal',
  weemo: 'sightcall',
  'multi-device-hybrid-apps': 'visual-studio-cordova',
  '.net-4.5.2': '.net-4.5',
  ...
  'func-delegate': 'delegates',
  'function-object': 'functor',
  transparentdataencryption: 'tde',
  'android-lollipop': 'android-5.0-lollipop',
  panoramic: 'panoramas',
  julia: 'julia-lang',
  ...
  'osx-yosemite10.10': 'osx-yosemite',
  ...
  'django-multi-db': 'django-orm',
  'bounded-wildcard': 'pecs',
  ...
  ilist: 'list',
  'peano-numbers': 'successor-arithmetics',
  cstring: 'c-strings',
  'intellij-idea-14': 'intellij-14',
  'css-combinators': 'css-selectors',
  'stackoverflow-api': 'stackexchange-api',
  'work-item-tracking': 'tfs-workitem',
  'work-item': 'tfs-workitem',
  'process-template': 'tfs-process-template',
  'android-ui': 'android',
  'self-executing-function': 'iife',
  'dust.js-linkedin': 'dust.js',
  cpanm: 'cpan',
  'css-box-model': 'css',
  'node-async': 'async.js',
  ...
  videojs: 'video.js',
  uber: 'uber-api',
  'azure-web-apps': 'azure-web-sites',
  'smartbear-testcomplete': 'testcomplete',
  'big-theta': 'big-o',
  formulas: 'formula',
  'asymptotic-complexity': 'complexity-theory',
  'font-weight': 'css',
  'date-manipulation': 'manipulation',
  'pdb-python': 'pdb',
  'swift-generics': 'generics',
  cljx: 'clojure',
  'sql-server-express-2012': 'sql-server-2012-express',
  'yield-keyword': 'yield',
  ...
  uriencoding: 'urlencode',
  'nw.js': 'node-webkit',
  'angular-directive': 'angularjs-directive',
  dialects: 'dialect',
  'jquery-core': 'jquery',
  ...
  'jquery-live': 'jquery',
  asn1: 'asn.1',
  geopositioning: 'geolocation',
  iads: 'iad',
  'oracle-commerce': 'atg',
  qliksense: 'qlikview',
  'qlikview.next': 'qlikview',
  habtm: 'has-and-belongs-to-many',
  apiary: 'apiary.io',
  'realm.io': 'realm',
  infix: 'infix-notation',
  'azure-app-service': 'azure-web-sites',
  react: 'reactjs',
  'custom-routes': 'routes',
  routing: 'routes',
  'document.ready': 'document-ready',
  claims: 'claims-based-identity',
  'xml-file': 'xml',
  'microsoft-web-deploy': 'webdeploy',
  uidynamics: 'uikit-dynamics',
  ...
  'entity-framework-4.3.1': 'entity-framework-4.3',
  'entity-framework-4.2': 'entity-framework-4.1',
  'laravel-5.1': 'laravel-5',
  'fedex-api': 'fedex',
  'fedex-shipping': 'fedex',
  mining: 'data-mining',
  androiddesignsupport: 'android-design-library',
  angles: 'angle',
  dockerfile: 'docker',
  'lxc-docker': 'docker',
  ...
  'active-record-query': 'activerecord',
  'activerecord-relation': 'activerecord',
  clicked: 'click',
  'javascript-async-await': 'ecmascript-async-await',
  'google-realtime-api': 'google-drive-realtime-api',
  'alt-attribute': 'alt',
  efi: 'uefi',
  es7: 'ecmascript-7',
  ...
  tika: 'apache-tika',
  'sql-server-express-2008': 'sql-server-2008-express',
  ...
  'aurelia-binding': 'aurelia',
  'aurelia-navigation': 'aurelia',
  'aurelia-router': 'aurelia',
  'aurelia-validation': 'aurelia',
  'aurelia-event-aggregator': 'aurelia',
  'aurelia-templating-router': 'aurelia',
  'aurelia-cli': 'aurelia',
  lmer: 'lme4',
  'angular-http': 'angularjs-http',
  ...
  'angularjs-ng-class': 'ng-class',
  'angular-ng-class': 'ng-class',
  fcgi: 'fastcgi',
  meanio: 'mean.io',
  'date-calculation': 'date-arithmetic',
  itest: 'recharge',
  'waterline.js': 'waterline',
  controlleras: 'angularjs-controlleras',
  genetic: 'genetic-algorithm',
  'angularjs-ng-options': 'ng-options',
  worklight: 'ibm-mobilefirst',
  ptr: 'pointers',
  'aws-ec2': 'amazon-ec2',
  'aws-command-line': 'aws-cli',
  tsv: 'csv',
  'angularjs-resource': 'ngresource',
  'flash-player': 'flash',
  'flash-ide': 'flash',
  'android-m': 'android-6.0-marshmallow',
  'android-marshmallow': 'android-6.0-marshmallow',
  'wp-query': 'wordpress',
  ...
  aarch64: 'arm64',
  'swift-array': 'arrays',
  'android-toolbar': 'android-actionbar-compat',
  fab: 'floating-action-button',
  'singleton-methods': 'singleton',
  ...
  make: 'makefile',
  'vanity-url': 'friendly-url',
  storm: 'apache-storm',
  'ca-ac': 'rally',
  'agile-central': 'rally',
  'oracle-service-cloud': 'rightnow-crm',
  'here-maps': 'here-api',
  uhd: 'usrp',
  'apple-tvos': 'tvos',
  jointable: 'join',
  ...
  knppaginatorbundle: 'knppaginator',
  'gh-pages': 'github-pages',
  'play-json': 'playframework-json',
  ...
  'openshift-enterprise': 'openshift',
  wallet: 'passbook',
  camel: 'apache-camel',
  'string-split': 'split',
  shapedrawable: 'android-shapedrawable',
  'android-avd': 'avd',
  'f#-make': 'f#-fake',
  'ia-32': 'x86',
  'non-ascii-chars': 'non-ascii-characters',
  'accented-strings': 'non-ascii-characters',
  svgz: 'svg',
  repeating: 'repeat',
  'swift2.1': 'swift2',
  es2015: 'ecmascript-6',
  'genymotion-call': 'genymotion',
  'u-law': 'mu-law',
  jdk9: 'java-9',
  'function-template': 'function-templates',
  'laravel-paginate': 'laravel-pagination',
  jasperprint: 'jasper-reports',
  dialogue: 'dialog',
  'android-6.0.1': 'android-6.0-marshmallow',
  blade: 'laravel-blade',
  truetype: 'true-type-fonts',
  'case-expression': 'case',
  'case-statement': 'case',
  phtml: 'php',
  multipart: 'multipartform-data',
  ...
  crontab: 'cron',
  wpdb: 'wordpress',
  'angular-services': 'angularjs-service',
  'universal-time': 'utc',
  'custom-tag': 'custom-tags',
  customtags: 'custom-tags',
  'angularjs-ng-show': 'ng-show',
  def: 'function',
  'asp.net-5': 'asp.net-core',
  'asp.net-mvc-6': 'asp.net-core-mvc',
  'entity-framework-7': 'entity-framework-core',
  ...
  'recyclerview-layout': 'android-recyclerview',
  'appc-ti': 'appcelerator-titanium',
  'titanium-android': 'appcelerator-titanium',
  'titanium-proxy': 'appcelerator-titanium',
  fscanf: 'scanf',
  sscanf: 'scanf',
  db2i: 'db2-400',
  'appc-studio': 'appcelerator-studio',
  'appc-alloy': 'appcelerator-alloy',
  'vs-unit-testing-framework': 'mstest',
  saml2: 'saml-2.0',
  'icon-fonts': 'fonts',
  eager: 'eager-loading',
  owl2: 'owl-carousel-2',
  ...
  'c#-nameof': 'nameof',
  reviews: 'review',
  'azure-mobile-app': 'azure-mobile-services',
  'bootstrap-framework': 'twitter-bootstrap',
  d3js: 'd3.js',
  'es6-harmony': 'ecmascript-6',
  'firebase-android': 'firebase',
  'titanium-modules': 'appcelerator-titanium',
  slimframework: 'slim',
  'negative-margin': 'margin',
  uitableviewcelll: 'uitableview',
  'simplexml-load-string': 'simplexml',
  'crashlytics-android': 'crashlytics',
  graphael: 'raphael',
  'phonegap-plugins': 'cordova-plugins',
  'source-to-source': 'transpiler',
  'dom-events': 'javascript-events',
  realmswift: 'realm',
  'azure-arm': 'azure-resource-manager',
  'project-oxford': 'microsoft-cognitive',
  textureview: 'android-textureview',
  mediarecorder: 'android-mediarecorder',
  'android-realm': 'realm',
  'realm-cocoa': 'realm',
  'php-mysqlidb': 'mysqli',
  'excel-indirect': 'excel-formula',
  'excel-match': 'excel-formula',
  packages: 'package',
  'data.frame': 'dataframe',
  'mvc-core': 'asp.net-core-mvc',
  'intellij-2016.1': 'intellij-idea',
  'python-xray': 'python-xarray',
  'spring-junit': 'spring-test',
  'vertx.io': 'vert.x',
  vertx: 'vert.x',
  vertx3: 'vert.x',
  onedefinitionrule: 'one-definition-rule',
  odr: 'one-definition-rule',
  'visual-studio-online': 'azure-devops',
  'inline-if': 'conditional-operator',
  ble: 'bluetooth-lowenergy',
  unity: 'unity3d',
  'swift2.2': 'swift2',
  'ansible-playbook': 'ansible',
  'fabric-twitter': 'twitter-fabric',
  'gulp.watch': 'gulp-watch',
  'qt-connection': 'signals-slots',
  'unix-socket': 'unix-domain-sockets',
  'swift2.2.1': 'swift2',
  amazonapi: 'amazon-api',
  eventsource: 'server-sent-events',
  sorted: 'sorting',
  'ibm-was-oc': 'websphere',
  'google-analytics-filters': 'google-analytics',
  ...
  'jquery-droppable': 'jquery-ui-droppable',
  'jquery-autocomplete': 'jquery-ui-autocomplete',
  'jquery-tabs': 'jquery-ui-tabs',
  'select-menu': 'jquery-ui-selectmenu',
  'jquery-slider': 'jquery-ui-slider',
  'jquery-spinner': 'jquery-ui-spinner',
  'jquery-tooltip': 'jquery-ui-tooltip',
  latin1: 'iso-8859-1',
  'utf8-decode': 'utf-8',
  'jquery-dialog': 'jquery-ui-dialog',
  'jquery-resizable': 'jquery-ui-resizable',
  protoc: 'protocol-buffers',
  'sql-copy': 'postgresql-copy',
  'jquery-widget-factory': 'jquery-ui-widget-factory',
  selectable: 'jquery-ui-selectable',
  'jquery-ui-menubar': 'jquery-ui-menu',
  'jquery-accordion': 'jquery-ui-accordion',
  'query-plans': 'sql-execution-plan',
  'explain-plan': 'sql-execution-plan',
  'query-execution-plans': 'sql-execution-plan',
  'query-plan': 'sql-execution-plan',
  'execution-plan': 'sql-execution-plan',
  'findall-prolog': 'prolog-findall',
  '4th-dimension': '4d-database',
  '4d': '4d-database',
  ...
  oraclejdk: 'java',
  'apache-hive': 'hive',
  'dragon-naturallyspeaking': 'naturallyspeaking',
  ...
  jsonobject: 'json',
  'laravel-5.2': 'laravel-5',
  'laravel-5.3': 'laravel-5',
  'windows-bash': 'windows-subsystem-for-linux',
  ...
  'table-valued-function': 'user-defined-functions',
  'table-value-function': 'user-defined-functions',
  'table-value-functions': 'user-defined-functions',
  ddk: 'wdk',
  ...
  feign: 'netflix-feign',
  'fsharp.data.typeproviders': 'f#-data',
  ecs: 'amazon-ecs',
  unparseable: 'parseexception',
  sede: 'dataexplorer',
  'main-activity': 'android-activity',
  'swift2.3': 'swift2',
  'google-analytics-android': 'google-analytics-sdk',
  ...
  'scala-macros': 'macros',
  fps: 'frame-rate',
  'phaser.io': 'phaser-framework',
  oauth2: 'oauth-2.0',
  cookbook: 'chef',
  directive: 'angularjs-directive',
  'compiler-design': 'compiler-construction',
  'polymer-1.x': 'polymer-1.0',
  vuejs: 'vue.js',
  dcos: 'mesosphere',
  ...
  'css-borders': 'css',
  'jenkins-workflow': 'jenkins-pipeline',
  jenkinsfile: 'jenkins-pipeline',
  javaassist: 'javassist',
  memorystream: 'stream',
  highstock: 'highcharts',
  highmaps: 'highcharts',
  'swift3.0.1': 'swift3',
  'web-control': 'web-controls',
  ...
  'asp.net-core-1.1': 'asp.net-core-1.0',
  trait: 'traits',
  jade: 'pug',
  ...
  'templates-deduction': 'template-deduction',
  'laravel-eloquent': 'eloquent',
  'chrome-web-driver': 'selenium-chromedriver',
  'ant-design': 'antd',
  'keystone.js': 'keystonejs',
  ia64: 'itanium',
  'vso-build': 'azure-pipelines',
  'visual-studio-2010-sp1': 'visual-studio-2010',
  'visual-studio-2010-rc': 'visual-studio-2010',
  'visual-studio-2010-beta-1': 'visual-studio-2010',
  ...
  cells: 'cell',
  vectordrawable: 'android-vectordrawable',
  'command-prompt': 'cmd',
  'select-query': 'select',
  'windows-applications': 'windows',
  'force.com': 'salesforce',
  'cmake-gui': 'cmake',
  contactscontract: 'android-contacts',
  edge: 'edge-detection',
  'youtube-v3-api': 'youtube-api-v3',
  vue2: 'vuejs2',
  'css-font-weight': 'css',
  surefire: 'maven-surefire-plugin',
  'html-dataset': 'custom-data-attribute',
  toggleclass: 'jquery',
  removeclass: 'jquery',
  'android-virtual-keyboard': 'virtual-keyboard',
  ...
  rro: 'microsoft-r',
  'jquery-after': 'jquery',
  'elastic-load-balancer': 'amazon-elb',
  plt: 'matplotlib',
  'database-trigger': 'triggers',
  ipp: 'intel-ipp',
  'filenet-cpe': 'filenet-content-engine',
  bulletphysics: 'bullet',
  'http-request': 'httprequest',
  'dotnetnuke-module': 'dotnetnuke',
  'dotnetnuke-settings': 'dotnetnuke',
  ...
  exponentjs: 'expo',
  tabpanel: 'tabs',
  'angular1.6': 'angularjs-1.6',
  'jquery-callback': 'jquery',
  'jquery-get': 'jquery',
  'jquery-post': 'jquery',
  'swift3.1': 'swift3',
  'stanford-parser': 'stanford-nlp',
  'corenlp-server': 'stanford-nlp',
  'aws-sdk-js': 'aws-sdk',
  'jquery-find': 'jquery',
  'css-grids': 'css-grid',
  ...
  'office365-restapi': 'office365api',
  'jquery-css': 'jquery',
  'jquery-on': 'jquery-events',
  hashalgorithm: 'hash',
  ionic3: 'ionic2',
  angular2: 'angular',
  angular4: 'angular',
  'angular4.x': 'angular',
  'vs-mobile-center': 'mobile-center',
  ...
  c5: 'concrete5',
  'aws-sdk-go': 'aws-sdk',
  'stanford-nlp-server': 'stanford-nlp',
  'aws-sdk-nodejs': 'aws-sdk',
  'fabric-composer': 'hyperledger-composer',
  show: 'show-hide',
  hide: 'show-hide',
  ...
  linearmodels: 'linear-regression',
  'android.harware.camera2': 'android-camera2',
  camera2: 'android-camera2',
  aiql: 'ms-app-analytics',
  'quality-center': 'hp-quality-center',
  'ajax-form': 'ajaxform',
  digest: 'hash',
  ...
  extraction: 'extract',
  'remote-notifications': 'push-notification',
  substrings: 'substring',
  'codemirror-modes': 'codemirror',
  'non-standard-evaluation': 'nse',
  normalisation: 'normalization',
  'amazon-javascript-sdk': 'aws-sdk',
  'ember-cp-validation': 'ember-cp-validations',
  'dict-comprehension': 'dictionary-comprehension',
  'azure-graph-api': 'azure-ad-graph-api',
  'angularjs-ng-if': 'angular-ng-if',
  'ng-if-else': 'angular-ng-if',
  'jenkins-shared-libraries': 'jenkins-pipeline',
  hyperledger: 'hyperledger-fabric',
  'azure-directory-b2c': 'azure-ad-b2c',
  'directx-12': 'direct3d12',
  cryptographichashfunction: 'cryptographic-hash-function',
  'vs-team-services': 'azure-devops',
  ...
  'va-list': 'variadic-functions',
  'va-arg': 'variadic-functions',
  ...
  mongocsharpdriver: 'mongodb-.net-driver',
  'mongo-csharp-driver': 'mongodb-.net-driver',
  'mongodb-csharp': 'mongodb-.net-driver',
  'intellij-idea-15': 'intellij-15',
  painless: 'elasticsearch-painless',
  pod: 'cocoapods',
  'parametrized-constructor': 'parameterized-constructor',
  emulate: 'emulation',
  emulator: 'emulation',
  'static-function': 'static-functions',
  'objc-bridging-header': 'bridging-header',
  'configuration-files': 'config',
  'wordpress-shortcode': 'shortcode',
  vr: 'virtual-reality',
  osk: 'on-screen-keyboard',
  'aws-cloudformation': 'amazon-cloudformation',
  'angular2-material': 'angular-material2',
  'windows-subsystem': 'windows-unix',
  rails5: 'ruby-on-rails-5',
  rds: 'amazon-rds',
  torrent: 'bittorrent',
  'multi-monitor': 'multiple-monitors',
  ...
  bs4: 'beautifulsoup',
  'jquery-click-event': 'jquery-events',
  'azure-cognitive-services': 'microsoft-cognitive',
  'ms-dos': 'dos',
  freedos: 'dos',
  'pc-dos': 'dos',
  8086: 'x86-16',
  ...
  'share-intent': 'android-intent',
  'css-custom-properties': 'css-variables',
  nifi: 'apache-nifi',
  'az-application-insights': 'azure-application-insights',
  'ms-application-insights': 'azure-application-insights',
  'firebase-firestore': 'google-cloud-firestore',
  firestore: 'google-cloud-firestore',
  'firebase-functions': 'google-cloud-functions',
  'windows-azure-queues': 'azure-queues',
  'windows-azure-diagnostics': 'azure-diagnostics',
  'windows-azure-networking': 'azure-virtual-network',
  'azure-networking': 'azure-virtual-network',
  'windows-azure-pack': 'azure-pack',
  'windows-azure-connect': 'azure-connect',
  'cloud-firestore': 'google-cloud-firestore',
  'firebase-cloud-firestore': 'google-cloud-firestore',
  'chartjs-2.6.0': 'chart.js2',
  dialogflow: 'api.ai',
  'apache-spark-ml': 'apache-spark-mllib',
  xarray: 'python-xarray',
  'data-type-conversion': 'type-conversion',
  wsl: 'windows-subsystem-for-linux',
  'linking-errors': 'linker-errors',
  'link-errors': 'linker-errors',
  'multiple-definitions': 'multiple-definition-error',
  'dwm-api': 'dwm',
  'laravel-5.4': 'laravel-5',
  'laravel-5.5': 'laravel-5',
  ...
  'auxil-excel-add-in': 'invantive-control',
  'openlink-virtuoso': 'virtuoso',
  'ajax-request': 'ajax',
  ajaxtags: 'ajax',
  'ajax-success': 'ajax',
  'bluemix-appid': 'ibm-appid',
  'firebase-cloud-functions': 'google-cloud-functions',
  'carto-mobile': 'nutiteq',
  ...
  aldryn: 'divio',
  'google-cloud-ml-engine': 'google-cloud-ml',
  javaslang: 'vavr',
  'amazon-sts': 'aws-sts',
  gke: 'google-container-engine',
  'codeigniter-classloader': 'codeigniter',
  'codeigniter-hooks': 'codeigniter',
  'codeigniter-helpers': 'codeigniter',
  'codeigniter-upload': 'codeigniter',
  'aws-vpc': 'amazon-vpc',
  'duckduckgo-search': 'duckduckgo',
  'atlassian-stash': 'bitbucket-server',
  'atlassian-bitbucketserver': 'bitbucket-server',
  scylladb: 'scylla',
  'jdk1.8.0': 'java-8',
  'build.gradle.kts': 'gradle-kotlin-dsl',
  pythonnet: 'python.net',
  'visual-studio-for-mac': 'visual-studio-mac',
  'asp.net-boilerplate': 'aspnetboilerplate',
  'vs-app-center': 'visual-studio-app-center',
  'aws-redshift': 'amazon-redshift',
  'spring-config': 'spring',
  'google-plus-one': 'google-plus',
  'firebase-anonymous-authentication': 'firebase-authentication',
  mongolab: 'mlab',
  'mayavi-mlab': 'mayavi.mlab',
  'factory-girl': 'factory-bot',
  datapicker: 'datepicker',
  'firebase-notifications': 'firebase-cloud-messaging',
  'google-kubernetes-engine': 'google-container-engine',
  'dynamics-365-sales': 'dynamics-365',
  'xcode9.2-beta': 'xcode9.2',
  parsexml: 'xml-parsing',
  'google-guava-cache': 'guava',
  'ssdt-bi': 'ssdt',
  'ibm-bluemix': 'ibm-cloud',
  'bluemix-mobile-services': 'ibm-mobile-services',
  bluemixtools: 'ibm-cloud-tools',
  'bluemix-plugin': 'ibm-cloud-plugin',
  osx: 'macos',
  rnn: 'recurrent-neural-network',
  'non-printable': 'non-printing-characters',
  ...
  xmm: 'sse',
  'facebook-account-kit': 'account-kit',
  'turboc++': 'turbo-c++',
  'azure-web-app-service': 'azure-web-sites',
  'optional-arguments': 'optional-parameters',
  'dynamics-crm-365': 'dynamics-365',
  'microsoft-dynamics-webapi': 'dynamics-crm-webapi',
  pip3: 'pip',
  ...
  reasonml: 'reason',
  'word-web-addins': 'office-js',
  'outlook-web-addins': 'office-js',
  'wix.com': 'wixcode',
  mingw64: 'mingw-w64',
  piwik: 'matomo',
  icarus: 'iverilog',
  ...
  'nested-gridview': 'gridview',
  gce: 'google-compute-engine',
  'aws-athena': 'amazon-athena',
  'linq-query-syntax': 'linq',
  'ios-autolayout': 'autolayout',
  db2400: 'db2-400',
  'radius-protocol': 'radius',
  'kronos-wfc': 'kronos-workforce-central',
  rdfstore: 'triplestore',
  nav: 'navigation',
  dgrid: 'dojo',
  'fluent-entity-framework': 'entity-framework',
  'entity-framework-designer': 'entity-framework',
  'sql-to-entity-framework': 'entity-framework',
  'entity-framework-core-migrations': 'entity-framework-core',
  firewatir: 'watir',
  phpdocumenter: 'phpdoc',
  'aws-ecs': 'amazon-ecs',
  binder: 'android-binder',
  'html-validation': 'validation',
  softlayer: 'ibm-cloud-infrastructure',
  d3v5: 'd3.js',
  opencobol: 'gnucobol',
  'gnu-cobol': 'gnucobol',
  ...
  factorygirl: 'factory-bot',
  'scala-implicits': 'implicit',
  ppc: 'powerpc',
  'unique-id': 'uniqueidentifier',
  'application-lifecycle': 'lifecycle',
  tapply: 'apply',
  mata: 'stata',
  uisplitview: 'uisplitviewcontroller',
  ...
  'spark-structured-streaming': 'structured-streaming',
  'jquery-multiselect': 'jquery-ui-multiselect',
  'jquery-filter': 'jquery',
  'jquery-effects': 'jquery',
  'code-timing': 'benchmarking',
  'spark-framework': 'spark-java',
  'pentaho-data-integration': 'pentaho-spoon',
  tez: 'apache-tez',
  'exception-handling': 'exception',
  'argument-deduction': 'template-deduction',
  'convolutional-neural-network': 'conv-neural-network',
  emr: 'amazon-emr',
  'elastic-map-reduce': 'amazon-emr',
  appstoreconnect: 'itunesconnect',
  'dask.distributed': 'dask-distributed',
  'aws-sns': 'amazon-sns',
  'eclipse-webtools': 'eclipse-wtp',
  nextjs: 'next.js',
  watson: 'ibm-watson',
  qweb: 'odoo-qweb',
  'qweb-report': 'odoo-qweb',
  vuetify: 'vuetify.js',
  ...
  'entity-framework-core-2.1': 'ef-core-2.1',
  ...
  'material-design-light': 'material-design-lite',
  'amazon-device-farm': 'aws-device-farm',
  'analog-digital-converter': 'adc',
  'file-moving': 'file-move',
  'android-pie': 'android-9.0-pie',
  'android-p': 'android-9.0-pie',
  mapkitannotation: 'mkannotation',
  mkmapviewdelegate: 'mkmapview',
  unet: 'unity3d-unet',
  postfix: 'postfix-mta',
  mws: 'amazon-mws',
  ...
  numerics: 'numeric',
  ghost: 'ghost-blog',
  'android-collapsingtoolbar': 'android-collapsingtoolbarlayout',
  collapsingtoolbarlayout: 'android-collapsingtoolbarlayout',
  py: 'python',
  'apache-ignite': 'ignite',
  clocks: 'clock',
  'data-stores': 'datastore',
  'uwp-community-toolkit': 'windows-community-toolkit',
  models: 'model',
  views: 'view',
  ...
  formats: 'format',
  chars: 'char',
  'form-authentication': 'forms-authentication',
  words: 'word',
  setting: 'settings',
  ...
  messages: 'message',
  documents: 'document',
  'android-architecture-workmanager': 'android-workmanager',
  'digital-certificate': 'certificate',
  'javax.sound.sampled': 'javasound',
  'javax.sound.midi': 'javasound',
  ...
  monitors: 'monitor',
  'webservices-client': 'webservice-client',
  'firebase-database': 'firebase-realtime-database',
  rule: 'rules',
  handles: 'handle',
  gestures: 'gesture',
  wraps: 'wrap',
  itemrenderers: 'itemrenderer',
  products: 'product',
  ...
  'google-api-explorer': 'google-apis-explorer',
  ...
  'hidden-fields': 'hidden-field',
  equations: 'equation',
  'named-scopes': 'named-scope',
  subscriptions: 'subscription',
  areas: 'area',
  'android-sharedpreferences': 'sharedpreferences',
  rollovers: 'rollover',
  'model-binders': 'modelbinders',
  stubs: 'stub',
  ...
  bitsets: 'bitset',
  figures: 'figure',
  servercontrol: 'servercontrols',
  demos: 'demo',
  manuals: 'manual',
  'number-rounding': 'rounding',
  'decimal-format': 'decimalformat',
  'python-3.7': 'python-3.x',
  'python-3.6': 'python-3.x',
  ...
  'vsts-restapi': 'azure-devops-rest-api',
  ...
  captions: 'caption',
  drives: 'drive',
  'web-user-controls': 'webusercontrol',
  webusercontrols: 'webusercontrol',
  'scripting-languages': 'scripting-language',
  'event-triggers': 'eventtrigger',
  nszombies: 'nszombie',
  digit: 'digits',
  'clean-url': 'clean-urls',
  lights: 'light',
  'bit-masks': 'bitmask',
  ...
  'google-amp': 'amp-html',
  'accelerated-mobile-page': 'amp-html',
  'method-overriding': 'override',
  'function-overriding': 'override',
  routedcommand: 'routed-commands',
  affiliates: 'affiliate',
  'log-files': 'logfile',
  routedevent: 'routed-events',
  ...
  avatars: 'avatar',
  'object-initializer': 'object-initializers',
  formhelper: 'form-helpers',
  'options-menu': 'optionmenu',
  quotas: 'quota',
  letters: 'letter',
  mappers: 'mapper',
  writers: 'writer',
  'update-attribute': 'update-attributes',
  subforms: 'subform',
  callout: 'callouts',
  'indexed-views': 'indexed-view',
  windowsformhost: 'windowsformshost',
  'symbol-tables': 'symbol-table',
  modalpopups: 'modalpopup',
  ...
  'remote-connections': 'remote-connection',
  ...
  'class-attribute': 'class-attributes',
  aggregators: 'aggregator',
  phrases: 'phrase',
  discounts: 'discount',
  hostheader: 'hostheaders',
  vendors: 'vendor',
  zones: 'zone',
  fiber: 'fibers',
  'service-pack': 'servicepacks',
  operand: 'operands',
  ...
  'background-agent': 'background-agents',
  ...
  'windows-forms-host': 'windowsformshost',
  ...
  'top-down': 'topdown',
  'thread-static': 'threadstatic',
  syndicationfeed: 'syndication-feed',
  strictmode: 'android-strictmode',
  'image-icon': 'imageicon',
  'react-dom': 'reactjs',
  cllocationmanager: 'core-location',
  'top-n': 'greatest-n-per-group',
  'amp-story': 'amp-stories',
  'custom-exceptions': 'exception',
  'checked-exceptions': 'exception',
  'unchecked-exception': 'exception',
  nn: 'neural-network',
  'google-calendar-api3': 'google-calendar-api',
  'pyspark-sql': 'apache-spark-sql',
  winword: 'ms-word',
  'mirth-connect': 'mirth',
  'py.test': 'pytest',
  'multi-tier': 'n-tier',
  ...
  website: 'web',
  'sharepoint-online-rest-api': 'sharepoint-rest-api',
  'aerospike-ce': 'aerospike',
  'vanilla-js': 'javascript',
  vanillajs: 'javascript',
  'spring-data-neo4j-5': 'spring-data-neo4j',
  'spring-data-neo4j-4': 'spring-data-neo4j',
  asp: 'asp.net',
  py3: 'python-3.x',
  'stl-algorithm': 'stl',
  ts: 'typescript',
  ...
  springjunit4classrunner: 'spring-test',
  'python-list': 'list',
  'apex-code': 'apex',
  'gcloud-python': 'google-cloud-python',
  'mdc-components': 'material-components-web',
  ...
  's3-bucket': 'amazon-s3',
  flatassembler: 'fasm',
  'nelmio-api-doc': 'nelmioapidocbundle',
  'nelmio-cors': 'nelmiocorsbundle',
  'swift4.2.1': 'swift4.2',
  dayofweek: 'weekday',
  bloom: 'bloom-filter',
  ...
  'string-to-datetime': 'date-parsing',
